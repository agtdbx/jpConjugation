...
Une application web moderne et robuste pour maîtriser la conjugaison des verbes et adjectifs japonais.
...
2. Dans la configuration, choisissez le nombre de mots, le mode d'affichage (Kanji, Romaji, Traduction) et ciblez précisément les temps à réviser.
3. Cliquez sur **Passer aux exercices**.
4. Saisissez les conjugaisons demandées.
